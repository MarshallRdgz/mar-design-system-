...
const BordCircularMascotAvatar = (props: ComponentProps<'svg'>) => {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 48 48">
      <rect width="47" height="47" x=".5" y=".5" fill="#052143" rx="23.5" />
      <rect width="47" height="47" x=".5" y=".5" stroke="#626C82" rx="23.5" />
      <path
        fill="url(#a)"
...
export default BordCircularMascotAvatar;
