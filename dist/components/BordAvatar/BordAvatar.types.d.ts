...
export declare enum BORD_AVATARS {
...
export type TbordAvatarsVariant = 'circularFigma' | 'circularUser' | 'circularWorld' | 'circularZeppelin' | 'circularBordMascot' | 'rectangularFigma' | 'rectangularUser' | 'rectangularWorld' | 'rectangularZeppelin' | 'rectangularBordMascot';
